...
CESA Matthew-Frédérick
    ...
    À propos de nous : Création de la page de présentation de l'équipe et du projet.

CHEMLI Hechmi
    Partenaires : Affichage de la page affichant les partenaires actuels, les avis, les rencontres, les témoignages,...
    Contact : Formulaire de contact
    Devenir Partenaire : Création d'une page supplémentaire (non présente sur la maquette initiale) contenant un formulaire de soumission de demande de partenariat.

ZHANG David
    -Accueil : Développement de la page d'entrée (index.html).
    Vie Étudiante : Conception de la page dédiée aux activités et à la vie sur le campus.
    Réalisation du Header et du Footer communs à toutes les pages.
